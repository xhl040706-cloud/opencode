...
export namespace Flag {
  ...
  export const COSTRICT_ENABLE_MODELS_FETCH =
    process.env.COSTRICT_ENABLE_MODELS_FETCH === undefined ? false : truthy("COSTRICT_ENABLE_MODELS_FETCH")
  ...
  export const COSTRICT_DISABLE_RAW_DUMP = truthy("COSTRICT_DISABLE_RAW_DUMP")
  ...
  export const OPENCODE_DISABLE_RAW_DUMP = truthy("OPENCODE_DISABLE_RAW_DUMP")
