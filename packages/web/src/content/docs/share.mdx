---
title: Share
description: Share your CoStrict conversations.
---

CoStrict's share feature allows you to create public links to your CoStrict conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, CoStrict:
...
CoStrict supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, CoStrict uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
[Learn more](/docs/enterprise) about using costrict-cli in your organization.
