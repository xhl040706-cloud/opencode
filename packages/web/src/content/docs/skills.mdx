...
Agent skills let CoStrict discover reusable instructions from your repo or home directory.
...
CoStrict searches these locations:

- Project config: `.costrict-cli/skill/<name>/SKILL.md`
- Global config: `~/.config/costrict-cli/skill/<name>/SKILL.md`
...
Create `.costrict-cli/skill/git-release/SKILL.md` like this:
...
CoStrict lists available skills in the `skill` tool description.
