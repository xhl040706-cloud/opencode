export const dict = {
  ...
  "store.console.newRepository": "Create Repository",
  ...
  "store.capability.category.accounting": "Accounting",
  ...
  "store.dashboard.nav.repositories": "Repositories",
  ...
  "store.home.hero.title": "Browse the store in one place",
  "store.home.hero.description": "Switch between skills, subagents, commands, and MCP servers without leaving the page.",
  "store.home.mainTabsLabel": "Store content types",
  "store.home.bestPractices.title": "Best practices",
  "store.home.bestPractices.description": "Placeholder guidance cards for future editorial recommendations.",
  "store.home.bestPractices.card1.title": "Start with trusted building blocks",
  "store.home.bestPractices.card1.description": "Pin a small set of dependable capabilities before expanding your stack.",
  "store.home.bestPractices.card2.title": "Keep categories focused",
  "store.home.bestPractices.card2.description": "Group related capabilities together so teammates can compare options faster.",
  "store.home.bestPractices.card3.title": "Review security posture",
  "store.home.bestPractices.card3.description": "Use scan summaries and metadata to validate packages before installation.",
  "store.home.bestPractices.card4.title": "Document install flows",
  "store.home.bestPractices.card4.description": "Capture install commands and usage notes where your team can reuse them.",
  ...
  "store.home.table.action": "Action",
  "store.home.table.copyInstall": "Copy install",
  "store.home.table.favoriteCount": "Favorites",
  ...
  "store.detail.favoriteCount": "Favorites",
  "store.detail.favorite": "Favorite",
  "store.detail.favorited": "Favorited",
  "store.detail.unfavorite": "Remove from favorites",
  "store.detail.favoriteSignIn": "Sign in to favorite",
  ...
  "workspace.home.step1.title": "Register a Device",
  "workspace.home.step1.description": "Install CoStrict CLI on your device and run `cs cloud start` to register.",
  "workspace.home.step2.title": "Create a Workspace",
  "workspace.home.step2.description": "Find your device in the sidebar, click \"+\" to pick a project directory.",
  "workspace.home.step3.title": "Connect & Code",
  "workspace.home.step3.description": "Click an active workspace to start a new chat. Chat with AI and manage sessions.",
  "workspace.home.step3.button": "Connect",
  ...
  "workspace.home.proTipContent": "Sign in with the same account on the CLI to link your devices automatically. This creates a secure persistent tunnel between your local environment and CoStrict Cloud.",
}
