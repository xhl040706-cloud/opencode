...
export const dict = {
  ...
  "store.console.newRepository": "创建仓库",
  ...
  "store.console.repositories.title": "仓库管理",
  "store.console.repositories.description": "管理您创建的、用于发布和同步商店内容的命名空间。",
  ...
  "store.dashboard.nav.repositories": "仓库管理",
  ...
  "store.home.bestPractices.description": "先用占位卡片承载后续的编辑推荐内容。",
  "store.home.bestPractices.card1.title": "先选择可信基础能力",
  "store.home.bestPractices.card1.description": "优先固定一组可靠能力，再逐步扩展工作流组合。",
  "store.home.bestPractices.card2.title": "保持分类足够聚焦",
  "store.home.bestPractices.card2.description": "按场景整理能力，方便团队快速筛选与比较。",
  "store.home.bestPractices.card3.title": "关注安全与元信息",
  "store.home.bestPractices.card3.description": "在安装前查看扫描摘要、作者和更新时间等关键信息。",
  "store.home.bestPractices.card4.title": "记录安装路径",
  "store.home.bestPractices.card4.description": "将常用安装命令和使用说明沉淀为可复用的团队实践。",
