export const dict = {
  ...
  "dialog.plugins.empty": "Plugins konfigureret i costrict.json",
  ...
  "toast.update.description": "En ny version af CoStrict ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CoStrict-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (costrict.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CoStrict understøtter ikke MCP-godkendelse endnu.',
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CoStrict",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan CoStrict ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan CoStrict er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CoStrict starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CoStrict.",
