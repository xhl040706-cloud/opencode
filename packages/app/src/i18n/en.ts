export const dict = {
  ...
  "store.itemCrud.subtitle": "Create a new {{type}}",
  "store.itemCrud.description": "Fill in the package information and content below.",
  ...
  "store.detail.quickInstall": "Quick Install",
